...
const symbolInputClass =
 "box-border h-9 w-full rounded border border-[var(--line-strong)] bg-[var(--bg-surface)] px-2 font-mono text-[15px] font-normal leading-none text-[var(--ink-strong)] outline-none ring-teal-500/30 focus:ring-1 ";
