...
export function TradePlansTable({ rows }: { rows: TradePlanRow[] }) {
 ...
 v == null ? <span className="text-[var(--ink-strong)]">—</span> : <span className="tabular-nums">{formatBdt(Number(v))}</span>,
 },
 {
 title: "Note",
 dataIndex: "notes",
 align: "left",
 width: 240,
 render: (v: string | null) => v ? <span>{v}</span> : <span className="text-[var(--ink-strong)]">—</span>,
 },
 {
 title: "",
 key: "actions",
