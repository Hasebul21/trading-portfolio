...
const defaultInputClass =
 "mt-1 w-full rounded-lg border border-[var(--line-strong)] bg-[var(--bg-surface)] px-3 py-2 font-mono text-[15px] font-normal text-[var(--ink-strong)] outline-none ring-zinc-400 focus:ring-2 ";

const smInputClass =
 "mt-1 w-full rounded-md border border-[var(--line-strong)] bg-[var(--bg-surface)] px-2 py-1.5 font-mono text-[15px] font-normal text-[var(--ink-strong)] outline-none ring-zinc-400 focus:ring-1 ";
...
export function SymbolField({
 ...
 {loadError ? (
 <p className="mt-1 text-[15px] font-normal leading-snug text-[var(--warn-700)] ">
 {size === "sm"
