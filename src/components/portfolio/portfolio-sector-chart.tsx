        ...
        <section className="rounded-lg border border-teal-200/50 bg-white/75 p-3 shadow-md shadow-teal-950/[0.05] ring-1 ring-black/[0.03] backdrop-blur-sm dark:border-teal-900/35 dark:bg-zinc-900/60 dark:shadow-black/30 dark:ring-white/[0.05]">
            <div className="flex flex-col gap-2 lg:flex-row lg:items-start lg:justify-between">
                <div className="min-w-0">
                    <p className="text-[12px] font-normal uppercase tracking-[0.2em] text-zinc-50">
                        Sector allocation
                    </p>
                    <p className="mt-0.5 text-[15px] font-normal text-zinc-50">
                    ...
                    <div className="flex justify-center sm:justify-start">
                        ...
                        >
                            <div className="absolute inset-[14px] flex items-center justify-center rounded-full border border-white/70 bg-white/90 text-center shadow-inner dark:border-zinc-800/70 dark:bg-zinc-950/90">
                                <div>
                                    <p className="text-[9px] font-normal uppercase tracking-[0.15em] text-zinc-50">
                                        Sectors
                                    </p>
                                    <p className="mt-0.5 text-[16px] font-semibold leading-none text-zinc-50">
                                        {slices.length}
                                    </p>
                                </div>
                            </div>
                    ...
                    <div className="grid min-w-0 gap-1.5 sm:min-w-[14rem]">
                        {slices.map((slice) => (
                            ...
                            >
                                ...
                                />
                                <div className="min-w-0">
                                    <p className="truncate text-[12px] font-medium text-zinc-50">
                                        {slice.sector}
                                    </p>
                                    <p className="text-[11px] font-normal text-zinc-50">
                                        {formatBdt(slice.investedBdt)} BDT
                                    </p>
                                </div>
                                <p className="text-[11px] font-semibold tabular-nums text-zinc-50 flex-shrink-0">
