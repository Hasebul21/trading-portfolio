...
export function PortfolioLiveShell({
    ...
    const [hiddenSymbols, setHiddenSymbols] = useState(initialHiddenSymbols);
    ...
    const initialKey = useMemo(
        () =>
            `${initialHoldings
                ...
                .join("|")}|realized:${initialTotalRealizedBdt}|invested:${initialTotalInvestedBdt}|cash:${initialTotalCashAdjustmentsBdt}|div:${initialTotalCashDividendsBdt}|hidden:${initialHiddenSymbols.slice().sort().join(",")}`,
        [
            initialHoldings,
            initialTotalRealizedBdt,
            initialTotalInvestedBdt,
    ...
    useEffect(() => {
        ...
        setHiddenSymbols(initialHiddenSymbols);
    ...
    const refresh = useCallback(async () => {
        ...
        try {
            ...
            if (Array.isArray(data.hiddenSymbols)) {
                setHiddenSymbols(data.hiddenSymbols);
            }
