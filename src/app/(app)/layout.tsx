  ...
  return (
    <AntdAppProvider>
      <div className="app-shell flex min-h-full flex-1 flex-col">
        ...
        */}
        <header className="sticky top-0 z-40 border-b border-zinc-200/80 bg-white/85 shadow-sm shadow-zinc-900/5 backdrop-blur-xl dark:border-zinc-700/50 dark:bg-[#252b36]/92 dark:shadow-black/25">
          <div
        ...
        <main className="app-main relative mx-auto w-full min-w-0 max-w-[min(100%,1400px)] flex-1 px-3 py-4 pb-10 text-center text-[15px] leading-relaxed text-zinc-800 sm:px-6 sm:py-6 lg:px-8 dark:text-[#cdd4df]">
          <div
            className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(ellipse_90%_50%_at_50%_-20%,rgba(20,184,166,0.12),transparent_55%)] dark:bg-[radial-gradient(ellipse_80%_45%_at_50%_-15%,rgba(45,212,191,0.055),transparent_52%)]"
            aria-hidden
          />
          {children}
        </main>

        <footer className="mt-6 hidden border-t border-zinc-200/80 bg-gradient-to-b from-white/90 to-zinc-50 py-4 md:block dark:border-zinc-700/50 dark:from-[#1e232c]/95 dark:to-[#191d24]/95">
          <div className="mx-auto max-w-[min(100%,1400px)] px-4 sm:px-6 lg:px-8" aria-hidden />
        </footer>
