    ...
    <AntdAppProvider>
      <div className="app-shell flex min-h-full flex-1 flex-col">
        <header className="sticky top-0 z-40 border-b border-zinc-200/80 bg-white/75 shadow-sm shadow-zinc-900/5 backdrop-blur-xl dark:border-zinc-800/80 dark:bg-zinc-950/75 dark:shadow-black/20">
          <div className="mx-auto flex w-full max-w-[min(100%,1920px)] flex-col gap-2 px-3 py-2 sm:flex-row sm:items-center sm:gap-3 sm:px-4 sm:py-2.5 lg:px-6">
            <div className="min-w-0 flex-1">
              <AppShellNav />
            </div>
            <form action={signOut} className="flex justify-end sm:shrink-0">
              <button
                type="submit"
