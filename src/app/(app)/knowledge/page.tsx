...
export default function KnowledgePage() {
  return (
    <AppPageStack gapClass="gap-4 sm:gap-5" className="mx-auto max-w-6xl text-left">
      ...
      <section>
        <h2 className="mb-2 text-sm font-bold uppercase tracking-wide text-zinc-800 dark:text-zinc-200">
          DSE table playbook
        </h2>
      ...
      <section>
        ...
        <p className="mb-3 max-w-3xl text-[11px] leading-relaxed text-zinc-600 dark:text-zinc-400">
          Plain-language notes on common company metrics. Numbers in examples are illustrative only.
        </p>
        <FundamentalsCompact />
      </section>

      <p className="rounded-lg border border-zinc-200/80 bg-zinc-50/80 px-3 py-2 text-center text-[11px] leading-snug text-zinc-600 dark:border-zinc-700/60 dark:bg-zinc-900/50 dark:text-zinc-400">
