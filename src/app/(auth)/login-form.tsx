    ...
    <div className="rounded-xl border border-zinc-200 bg-white p-8 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <form action={formAction} className="mt-6 flex flex-col gap-4">
        ...
        <button
          type="submit"
          disabled={pending}
          className="flex items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-teal-600 to-emerald-600 px-4 py-2.5 text-[15px] font-normal text-white shadow-md shadow-teal-600/25 transition hover:brightness-110 disabled:opacity-60 dark:from-teal-500 dark:to-emerald-500"
        >
          {pending ? (
