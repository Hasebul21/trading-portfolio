...
export function RegisterForm() {
 ...
 <p className="mt-1 text-[15px] font-normal leading-snug text-[var(--ink-muted)] ">
 ...
 {state.message ? (
 <p className="mt-4 rounded-lg bg-[var(--gain-50)] px-3 py-2 text-[15px] font-normal text-[var(--gain-700)] ">
 {state.message}
 </p>
 ) : null}
