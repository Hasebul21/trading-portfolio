...
-- ---------------------------------------------------------------------------
-- draft_mip_monthly_headers / draft_mip_monthly_rows (Draft Monthly Investment Plan)
-- ---------------------------------------------------------------------------
...
-- (Same DDL is in 20260602120000_dividends.sql.)
--   * cash_dividend_bdt flows into the Portfolio "Unrealized P/L" KPI via the
--     same totalCashAdjustments bucket Settings → Cash adjustments uses.
--   * stock_dividend_shares (bonus shares) are injected into the holdings
--     ledger as a zero-cost `buy` transaction; bonus_tx_id links back to it.
-- ---------------------------------------------------------------------------
...
-- ---------------------------------------------------------------------------
-- Atomic guard against overselling on the transactions ledger.
-- (Same DDL is in 20260510160000_no_oversell_trigger.sql.)
-- ---------------------------------------------------------------------------
